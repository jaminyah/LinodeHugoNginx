...
*  __Production Environment: Case I__ - In this case, Nginx is configured to reverse proxy a Hugo server that is running in production. The site is available with URL `http://blog.example.com` .
...
*  __Production Environment: Case II__ - Here, Nginx is configured to server the static files generated by Wercker.
